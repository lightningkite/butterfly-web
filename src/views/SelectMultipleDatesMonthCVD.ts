...
import { copyDateAloneMod, dateAloneModRelative } from '../time/Date'
...
export class SelectMultipleDatesMonthCVD extends MonthCVD {
    public constructor() {
        ...
        const it_372 = iterFirstOrNull(this.dates.value);
        if (it_372 !== null) { 
            this.currentMonthObs.value = copyDateAloneMod(it_372, Date.prototype.setDate, 1);
        };
