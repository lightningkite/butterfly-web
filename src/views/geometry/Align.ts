...
//! Declares com.lightningkite.butterfly.views.geometry.AlignPair
...
export namespace AlignPair {
    //! Declares com.lightningkite.butterfly.views.geometry.AlignPair.Companion
