...
import { iterLastOrNull } from '../KotlinCollections'
import { NumberRange, checkIsInterface } from '../Kotlin'
import { ObservableProperty } from './ObservableProperty'
import { HasBackAction } from '../views/HasBackAction'
...
export class ObservableStack<T extends object> extends ObservableProperty<Array<T>> {
    ...
    public backPressPop(): boolean {
        const last = iterLastOrNull(this.stack);
        
        if (checkIsInterface<HasBackAction>(last, "ComLightningkiteButterflyViewsHasBackAction") && (last as HasBackAction).onBackPressed()) { return true }
        return this.pop();
    }
