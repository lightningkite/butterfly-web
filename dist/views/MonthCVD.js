...
class MonthCVD extends CustomViewDelegate_1.CustomViewDelegate {
    ...
    set currentOffset(value) {
        ...
        const temp203 = this.customView;
        if (temp203 !== null) {
            CustomView_1.customViewInvalidate(temp203);
        }
        ;
    }
    animateNextMonth() {
    ...
    onTouchDown(id, x, y, width, height) {
        ...
        const it_279 = day;
        if (it_279 !== null) {
            if (this.onTouchDownDate(it_279)) {
                return true;
            }
        }
    ...
    onTouchMove(id, x, y, width, height) {
        if (this.draggingId === id) {
            ...
            const it_291 = this.dayAtPixel(x, y, undefined);
            if (it_291 !== null) {
                return this.onTouchMoveDate(it_291);
            }
        }
        return true;
    }
    ...
    onTouchUp(id, x, y, width, height) {
        if (this.draggingId === id) {
            if (this.isTap) {
                const it_293 = this.dayAtPixel(x, y, undefined);
                if (it_293 !== null) {
                    this.onTap(it_293);
                }
            }
            ...
            const it_310 = this.dayAtPixel(x, y, undefined);
            if (it_310 !== null) {
                return this.onTouchUpDate(it_310);
            }
        }
        return true;
    }
