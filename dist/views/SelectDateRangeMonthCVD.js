...
// File: views/SelectDateRangeMonthCVD.kt
...
class SelectDateRangeMonthCVD extends MonthCVD_1.MonthCVD {
    constructor() {
        super();
        this.draggingStart = true;
        this.start = new StandardObservableProperty_1.StandardObservableProperty(null, undefined);
        this.endInclusive = new StandardObservableProperty_1.StandardObservableProperty(null, undefined);
        const it_356 = this.start.value;
        if (it_356 !== null) {
            this.currentMonthObs.value = Date_1.copyDateAloneMod(it_356, Date.prototype.setDate, 1);
        }
        ;
        DisposeCondition_ext_1.xDisposableForever(this.start.onChange.subscribe((value) => {
            this === null || this === void 0 ? void 0 : this.invalidate();
        }, undefined, undefined));
        DisposeCondition_ext_1.xDisposableForever(ObservableProperty_ext_1.xObservablePropertySubscribeBy(this.endInclusive, undefined, undefined, (value) => {
            this === null || this === void 0 ? void 0 : this.invalidate();
        }));
...
//# sourceMappingURL=SelectDateRangeMonthCVD.js.map