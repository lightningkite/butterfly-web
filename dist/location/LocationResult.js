...
// File: location/LocationResult.kt
// Package: com.lightningkite.butterfly.location
const GeoCoordinate_1 = require("./GeoCoordinate");
const Kotlin_1 = require("../Kotlin");
//! Declares com.lightningkite.butterfly.location.LocationResult
class LocationResult {
    constructor(coordinate = new GeoCoordinate_1.GeoCoordinate(0.0, 0.0), accuracyMeters = 100.0, altitudeMeters = 0.0, altitudeAccuracyMeters = 100.0, headingFromNorth = 0.0, speedMetersPerSecond = 0.0) {
...
//# sourceMappingURL=LocationResult.js.map