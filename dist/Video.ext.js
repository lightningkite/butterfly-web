...
function videoUrlToBitmap(url, timeMs = 2000, onResult, onFail) {
    ...
    let snapImage = function () {
        ...
        if (success) {
            onResult(new Image_1.ImageRemoteUrl(image));
        }
        return success;
    };
...
//# sourceMappingURL=Video.ext.js.map