...
function xImageLoad(this_) {
    return (() => {
        try {
            return (() => {
                if (this_ instanceof Image_1.ImageRaw) {
                    return rxjs_1.from(createImageBitmap(new Blob([this_.raw])));
                }
                else if (this_ instanceof Image_1.ImageReference) {
                    return rxjs_1.from(createImageBitmap(this_.uri));
                }
                else if (this_ instanceof Image_1.ImageImageBitmap) {
                    return rxjs_1.of(this_.bitmap);
                }
                else if (this_ instanceof Image_1.ImageRemoteUrl) {
                ...
                else if (this_ instanceof Image_1.ImageResource) {
...
//# sourceMappingURL=Image.loadingRx.js.map