...
const ConstantObservableProperty_1 = require("./ConstantObservableProperty");
//! Declares com.lightningkite.butterfly.observables.FlatMappedObservableProperty
class FlatMappedObservableProperty extends ObservableProperty_1.ObservableProperty {
    ...
    get onChange() {
        ...
        return ObservableProperty_ext_1.xObservablePropertyObservableGet(this.basedOn).pipe(operators_1.switchMap((it) => ObservableProperty_ext_1.xObservablePropertyObservableGet(transformCopy(it)))).pipe(operators_1.skip(0));
    }
}
...
function xObservablePropertySwitchMapNotNull(this_, transformation) {
    return new FlatMappedObservableProperty(this_, (item) => (() => {
        if (item !== null) {
            ...
            return new ConstantObservableProperty_1.ConstantObservableProperty(null);
        }
    })());
}
...
class MutableFlatMappedObservableProperty extends MutableObservableProperty_1.MutableObservableProperty {
    constructor(basedOn, transformation) {
        super();
        this.basedOn = basedOn;
        this.transformation = transformation;
    ...
    get onChange() {
        const transformCopy = this.transformation;
        return ObservableProperty_ext_1.xObservablePropertyObservableGet(this.basedOn).pipe(operators_1.switchMap((it) => {
            const prop = transformCopy(it);
            if (this !== null) {
                this.lastProperty = prop;
            }
            ;
            return ObservableProperty_ext_1.xObservablePropertyObservableGet(prop);
...
//# sourceMappingURL=FlatMappedObservableProperty.js.map