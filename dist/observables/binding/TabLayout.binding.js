...
// File: observables/binding/TabLayout.binding.kt
...
//! Declares com.lightningkite.butterfly.observables.binding.bind>com.google.android.material.tabs.TabLayout
function xTabLayoutBind(this_, tabs, selected, allowReselect = false, toString) {
    this_.innerHTML = "";
    const myName = uuid_1.v4();
    const selectedIndicator = document.createElement("div");
    selectedIndicator.classList.add("butterfly-tab-indicator");
    this_.appendChild(selectedIndicator);
    const tabList = document.createElement("div");
    tabList.classList.add("butterfly-tab-list");
    ...
    for (const tab of tabs) {
        ...
        tabElement.classList.add("butterfly-tab");
    ...
    DisposeCondition_ext_1.xDisposableUntil(ObservableProperty_ext_1.xObservablePropertySubscribeBy(selected, undefined, undefined, (item) => {
...
function xTabLayoutBindIndex(this_, tabs, selected, allowReselect = false) {
    ...
    DisposeCondition_ext_1.xDisposableUntil(ObservableProperty_ext_1.xObservablePropertySubscribeBy(selected, undefined, undefined, (index) => {
        tabList.children.item(index * 2 + 1).checked = true;
        const tab = tabList.children.item(index * 2);
        selectedIndicator.style.left = tab.offsetLeft.toString() + "px";
        selectedIndicator.style.width = tab.offsetWidth.toString() + "px";
...
//# sourceMappingURL=TabLayout.binding.js.map